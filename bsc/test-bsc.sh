...
print_header() {
    echo -e "${BLUE}╔════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║   BSC Node Testing                     ║${NC}"
    echo -e "${BLUE}╚════════════════════════════════════════╝${NC}"
    echo ""
}
...
# Test BSC Mainnet RPC
echo -e "${BLUE}3. Testing BSC Mainnet RPC${NC}"
...
test_endpoint "Chain ID" "https://$DOMAIN/mainnet/rpc" "eth_chainId"

# Test BSC Testnet RPC
echo -e "${BLUE}4. Testing BSC Testnet RPC${NC}"
test_endpoint "Block Number" "https://$DOMAIN/testnet/rpc" "eth_blockNumber"
test_endpoint "Peer Count" "https://$DOMAIN/testnet/rpc" "net_peerCount"
test_endpoint "Sync Status" "https://$DOMAIN/testnet/rpc" "eth_syncing"
test_endpoint "Chain ID" "https://$DOMAIN/testnet/rpc" "eth_chainId"
